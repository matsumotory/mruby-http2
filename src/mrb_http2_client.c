...
static void mrb_http2_uri_free(mrb_state *mrb, struct mrb_http2_uri_t *uri)
{
  mrb_free(mrb, uri);
}
                             ...
                             size_t length, int flags, void *user_data)
{
  ...
  if (rv < 0) {
    ...
    if (err == SSL_ERROR_WANT_WRITE || err == SSL_ERROR_WANT_READ) {
      conn->want_io = (err == SSL_ERROR_WANT_READ ? WANT_READ : WANT_WRITE);
  ...
  if (!mrb_nil_p(conn->cb_block_hash)) {
    mrb_value cb_block =
        mrb_hash_get(conn->mrb, conn->cb_block_hash,
  ...
  case NGHTTP2_RST_STREAM:
    mrb_hash_set(conn->mrb, conn->response,
                 mrb_symbol_value(mrb_intern_cstr(
                     conn->mrb, "frame_send_header_rst_stream")),
                 mrb_true_value());
    break;
  case NGHTTP2_GOAWAY:
    mrb_hash_set(
                                  ...
                                  const nghttp2_frame *frame, void *user_data)
{
  ...
  case NGHTTP2_RST_STREAM:
    ...
    mrb_hash_set(conn->mrb, conn->response,
                 mrb_symbol_value(mrb_intern_cstr(
                     conn->mrb, "frame_recv_header_rst_stream")),
                 mrb_true_value());
    break;
  case NGHTTP2_GOAWAY:
    TRACER;
...

{
  ...
  case NGHTTP2_HEADERS:
    ...
    if (nghttp2_session_get_stream_user_data(session, frame->hd.stream_id)) {
      ...
      // const nghttp2_nv *nva = frame->headers.nva;
      mrb_hash_set(mrb, response_headers,
                   mrb_str_new(mrb, (char *)name, namelen),
                   mrb_str_new(mrb, (char *)value, valuelen));
      mrb_hash_set(mrb, conn->response, mrb_symbol_value(mrb_intern_cstr(
                                            conn->mrb, "response_headers")),
                   response_headers);
    }
    break;
  case NGHTTP2_GOAWAY:
    mrb_hash_set(conn->mrb, conn->response, mrb_symbol_value(mrb_intern_cstr(
                                                conn->mrb, "on_header_goway")),
                 mrb_true_value());
    break;
  }
  if (!mrb_nil_p(conn->cb_block_hash)) {
                                       ...
                                       size_t len, void *user_data)
{
  ...
  if (req) {
    ...
    body_data =
        mrb_hash_get(conn->mrb, conn->response,
    ...
    mrb_hash_set(conn->mrb, conn->response,
                 ...
                 body_data);
    mrb_hash_set(conn->mrb, conn->response,
                 mrb_symbol_value(mrb_intern_cstr(conn->mrb, "body_length")),
                 body_len);
  }
  if (!mrb_nil_p(conn->cb_block_hash)) {
    mrb_value cb_block = mrb_hash_get(
        conn->mrb, conn->cb_block_hash,
...
static void
mrb_http2_setup_nghttp2_callbacks(mrb_state *mrb,
                                     ...
                                     struct mrb_http2_request_t *req)
{
  ...
  const nghttp2_nv nva[] = {
      ...
      MAKE_NV("accept", "*/*"), MAKE_NV("accept-encoding", GZIP),
...
static mrb_value mrb_http2_client_request(mrb_state *mrb, mrb_value self)
{
  ...
  ctx->req = (struct mrb_http2_request_t *)mrb_malloc(
      mrb, sizeof(struct mrb_http2_request_t));
...
static mrb_value mrb_http2_client_set_uri(mrb_state *mrb, mrb_value self)
{
  ...
  char *uri;
  ctx->uri =
      (struct mrb_http2_uri_t *)mrb_malloc(mrb, sizeof(struct mrb_http2_uri_t));
...
static mrb_value mrb_http2_client_init(mrb_state *mrb, mrb_value self)
{
  ...
  ctx->uri = NULL;
  ctx->conn = (struct mrb_http2_conn_t *)mrb_malloc(
      mrb, sizeof(struct mrb_http2_conn_t));
...
void mrb_http2_client_class_init(mrb_state *mrb, struct RClass *http2)
{
  ...
  mrb_define_method(mrb, client, "initialize", mrb_http2_client_init,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, client, "create_session",
                    mrb_http2_client_create_session, MRB_ARGS_NONE());
  mrb_define_method(mrb, client, "request_stream",
                    mrb_http2_client_request_stream, MRB_ARGS_NONE());
  mrb_define_method(mrb, client, "delete_session",
                    mrb_http2_client_delete_session, MRB_ARGS_NONE());
  mrb_define_method(mrb, client, "uri=", mrb_http2_client_set_uri,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "uri", mrb_http2_client_get_uri,
                    MRB_ARGS_NONE());

  mrb_define_method(mrb, client, "request", mrb_http2_client_request,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "inst_get", mrb_http2_client_inst_get,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, client, "send_callback", mrb_http2_set_send_callback,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "recv_callback", mrb_http2_set_recv_callback,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "before_frame_send_callback",
                    mrb_http2_set_before_frame_send_callback, MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "on_frame_send_callback",
                    mrb_http2_set_on_frame_send_callback, MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "on_frame_recv_callback",
                    mrb_http2_set_on_frame_recv_callback, MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "on_stream_close_callback",
                    mrb_http2_set_on_stream_close_callback, MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "on_data_chunk_recv_callback",
                    mrb_http2_set_on_data_chunk_recv_callback, MRB_ARGS_REQ(1));
  mrb_define_method(mrb, client, "on_header_callback",
                    mrb_http2_set_on_header_callback, MRB_ARGS_REQ(1));

  mrb_define_class_method(mrb, client, "http2_get", mrb_http2_client_get,
                          MRB_ARGS_REQ(1));
